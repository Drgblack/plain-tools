...
export const TOOL_SEO_ENTRIES: ToolSeoEntry[] = [
  ...
  },
  {
    ...
    description: "Compare two PDF files locally with text extraction and highlight differences page-by-page.",
  ...
  },
  {
    ...
    description: "Rotate PDF pages locally with per-page controls, thumbnail previews, and no upload workflow.",
  ...
  },
  {
    ...
    description: "Add text or image watermark overlays to PDF pages locally with adjustable opacity and placement.",
    learnHref: "/learn/no-uploads-explained",
    learnLabel: "No Uploads Explained",
  },
  {
    slug: "annotate-pdf",
    name: "Annotate PDF",
    description: "Add pen, highlight, and text annotations to PDF pages locally in your browser with no uploads.",
    learnHref: "/learn/no-uploads-explained",
    learnLabel: "No Uploads Explained",
  },
  {
  ...
  },
  {
    slug: "text-to-pdf",
    name: "Text to PDF",
    description: "Convert plain text and Markdown to PDF locally in your browser with no uploads or server-side processing.",
    learnHref: "/learn/no-uploads-explained",
    learnLabel: "No Uploads Explained",
  },
  {
  ...
  },
  {
    slug: "pdf-to-html",
    name: "PDF to HTML",
    description: "Convert PDF files to HTML locally with extracted text and optional embedded page previews.",
    learnHref: "/learn/how-to-verify-a-pdf-tool-doesnt-upload-your-files",
    learnLabel: "How to Verify a PDF Tool Does not Upload Your Files",
  },
  {
  ...
  },
  {
    ...
    description: "Generate QR codes locally for links and text with configurable size, colour, and error correction settings.",
    learnHref: "/learn/no-uploads-explained",
    learnLabel: "No Uploads Explained",
  },
  {
