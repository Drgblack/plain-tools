...
const TOOLS: CompareTool[] = [
  ...
  {
    bestFor: "users who want a polished all-in-one desktop PDF suite",
    displayName: "Wondershare PDFelement",
    localPositioning: "A heavier desktop-first suite with cloud add-ons and account packaging.",
    pricing: "subscription",
    privacy: "mixed",
    privacySummary:
      "Stronger local control than a pure upload-first app, but still not built around a lightweight no-upload browser story.",
    processing: "hybrid",
    slug: "wondershare-pdfelement",
    speedSummary: "Fast inside an installed environment, though heavier than a focused browser utility.",
  },
  {
    bestFor: "buyers who want a modern multi-device PDF suite",
    displayName: "UPDF",
    localPositioning: "Hybrid positioning with device apps, account sync, and desktop-oriented flows.",
    pricing: "subscription",
    privacy: "mixed",
    privacySummary:
      "Convenient cross-device packaging, but the messaging is still broader suite utility rather than strict local-first processing.",
    processing: "hybrid",
    slug: "updf",
    speedSummary: "Comfortable in app-driven workflows, with more overhead than a single-task browser tool.",
  },
  {
    bestFor: "enterprise buyers already committed to Nitro tooling",
    displayName: "Nitro PDF Pro",
    localPositioning: "Enterprise desktop suite with stronger managed-environment appeal than browser-first tools.",
    pricing: "subscription",
    privacy: "mixed",
    privacySummary:
      "Better for managed desktop estates than consumer utility traffic, but still not centered on no-upload browser use.",
    processing: "hybrid",
    slug: "nitro-pdf-pro",
    speedSummary: "Strong when deployed broadly, heavier for one-off utility jobs.",
  },
  {
    bestFor: "users who want a hosted form and annotation workflow",
    displayName: "DocHub",
    localPositioning: "Cloud-centric editing with collaboration and document-sharing expectations.",
    pricing: "freemium",
    privacy: "cloud-first",
    privacySummary:
      "Useful for hosted document collaboration, but much less aligned with local-only handling.",
    processing: "upload-first",
    slug: "dochub",
    speedSummary: "Good enough once a file is uploaded, but still bound to hosted processing.",
  },
  {
    bestFor: "casual users who want quick browser-side editing and forms",
    displayName: "PDFescape",
    localPositioning: "Web-first utility workflow with cloud-style expectations.",
    pricing: "freemium",
    privacy: "cloud-first",
    privacySummary:
      "Accessible for quick edits, but not a strong fit for privacy-first document handling.",
    processing: "upload-first",
    slug: "pdfescape",
    speedSummary: "Fast enough for simple jobs, though still dependent on the upload loop.",
  },
  {
    bestFor: "users who want an all-in-one hosted PDF workspace",
    displayName: "HiPDF",
    localPositioning: "Cloud-first utility set with converter-heavy positioning.",
    pricing: "freemium",
    privacy: "cloud-first",
    privacySummary:
      "Convenient for broad utility coverage, but the core path still assumes hosted processing.",
    processing: "upload-first",
    slug: "hipdf",
    speedSummary: "Reasonable for one-off tasks, but not as low-friction as a local browser route.",
  },
  {
    bestFor: "users who want a branded hosted PDF workflow without desktop setup",
    displayName: "LightPDF",
    localPositioning: "Hosted-first with some local-adjacent messaging, but cloud use remains central.",
    pricing: "freemium",
    privacy: "cloud-first",
    privacySummary:
      "More convenience-oriented than privacy-first, with the usual hosted trade-offs.",
    processing: "upload-first",
    slug: "lightpdf",
    speedSummary: "Smooth enough in the browser, but still includes transfer overhead.",
  },
  {
    bestFor: "lightweight web users who want quick utility coverage",
    displayName: "EasePDF",
    localPositioning: "Cloud-style route focused on breadth rather than local document control.",
    pricing: "freemium",
    privacy: "cloud-first",
    privacySummary:
      "Broad enough for casual use, but not differentiated by browser-first privacy handling.",
    processing: "upload-first",
    slug: "easepdf",
    speedSummary: "Acceptable for simple jobs, though still slower than direct local processing.",
  },
  {
    bestFor: "users who want simple hosted conversions with minimal setup",
    displayName: "DocFly",
    localPositioning: "Mostly hosted conversions and editing with account-style upsell paths.",
    pricing: "freemium",
    privacy: "cloud-first",
    privacySummary:
      "Easy to access, but the route remains more upload-first than privacy-first.",
    processing: "upload-first",
    slug: "docfly",
    speedSummary: "Fine for occasional jobs, with the usual upload/download friction.",
  },
  {
    bestFor: "teams that work inside education and classroom annotation flows",
    displayName: "Kami",
    localPositioning: "Collaboration-first document workflows with cloud and classroom ties.",
    pricing: "freemium",
    privacy: "mixed",
    privacySummary:
      "Good for shared annotation and classroom workflows, but not built around strict local handling.",
    processing: "hybrid",
    slug: "kami",
    speedSummary: "Useful in collaborative settings, though heavier than a focused local utility path.",
  },
  {
    bestFor: "Windows users who want a smaller installed PDF suite",
    displayName: "SwifDoo PDF",
    localPositioning: "Desktop-weighted utility suite with a more traditional installed-tool posture.",
    pricing: "subscription",
    privacy: "mixed",
    privacySummary:
      "Stronger local control than hosted-only brands, but not as cleanly browser-first as Plain Tools.",
    processing: "hybrid",
    slug: "swifdoo-pdf",
    speedSummary: "Solid once installed, though still more setup-heavy than a no-upload browser tool.",
  },
  {
    bestFor: "teams already standardized on an office productivity stack",
    displayName: "ONLYOFFICE PDF",
    localPositioning: "Document-suite positioning with more workspace context than utility-tool simplicity.",
    pricing: "freemium",
    privacy: "mixed",
    privacySummary:
      "Can fit broader office workflows, but the PDF story is less focused than a privacy-first utility site.",
    processing: "hybrid",
    slug: "onlyoffice-pdf",
    speedSummary: "Comfortable inside suite workflows, with more context overhead than a direct tool page.",
  },
]
