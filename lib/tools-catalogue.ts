...
export const TOOL_CATALOGUE: ToolDefinition[] = [
  ...
  },
  {
    ...
    category: "Security & Privacy",
    description:
      "Place a visual signature on a PDF locally using draw or typed input controls.",
    badge: "100% Local",
    icon: "PenTool",
    available: true,
  },
  {
    ...
    slug: "protect-pdf",
    category: "Security & Privacy",
    description: "Password-protect PDFs locally so opening requires the key you set.",
    badge: "100% Local",
    icon: "Lock",
    available: true,
  },
  {
    ...
    slug: "unlock-pdf",
    category: "Security & Privacy",
    description: "Unlock password-protected PDFs locally when you have the correct password.",
    badge: "100% Local",
    icon: "Unlock",
    available: true,
  },
  {
    ...
    description: "Run best-effort OCR locally and export searchable text output for scanned PDFs.",
    badge: "100% Local",
    icon: "ScanText",
    available: true,
  },
