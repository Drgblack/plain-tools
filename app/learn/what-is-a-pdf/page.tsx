        ...
        <article className="mx-auto max-w-2xl">
          ...
          <div className="space-y-12">
            ...
            <section>
              ...
              <p className="mt-3 text-[14px] leading-relaxed text-muted-foreground">
                <Link href="/" className="text-accent underline underline-offset-2 transition-colors hover:text-accent/80">
                  Plain PDF tools
                </Link>{" "}
            ...
            <section>
              ...
              <p className="mt-3 text-[14px] leading-relaxed text-muted-foreground">
                ...
                <Link href="/learn/how-pdfs-work" className="text-accent underline underline-offset-2 transition-colors hover:text-accent/80">
                  How PDFs Work
                </Link>.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="mt-4 text-[14px] leading-relaxed text-muted-foreground">
                ...
                <Link href="/tools/merge-pdf" className="text-accent underline underline-offset-2 transition-colors hover:text-accent/80">
                  merging
                </Link>,{" "}
                splitting, or reordering pages can be useful. Understanding the difference between{" "}
                <Link href="/learn/online-vs-offline-pdf-tools" className="text-accent underline underline-offset-2 transition-colors hover:text-accent/80">
