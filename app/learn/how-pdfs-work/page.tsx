          ...
          <div className="prose-custom space-y-10">
            ...
            <section>
              ...
              <p className="mt-4 text-[15px] leading-relaxed text-muted-foreground">
                ...
                <Link href="/learn/online-vs-offline-pdf-tools" className="text-accent underline underline-offset-4 transition-colors hover:text-accent/80">
            ...
            <section className="rounded-xl border border-accent/15 bg-[oklch(0.155_0.005_250)] p-6">
              ...
              <p className="text-[14px] leading-relaxed text-muted-foreground">
                ...
                <Link href="/learn/why-pdf-uploads-are-risky" className="text-accent underline underline-offset-4 transition-colors hover:text-accent/80">
