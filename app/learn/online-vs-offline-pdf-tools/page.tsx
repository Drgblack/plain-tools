        ...
        <article className="mx-auto max-w-2xl">
          ...
          <div className="mt-16 border-t border-accent/10 pt-10">
            ...
            <p className="mt-4 text-center text-[12px] text-muted-foreground/70">
              Try offline processing: <Link href="/tools/extract-pdf" className="text-accent hover:underline">Extract Pages</Link>, <Link href="/tools/merge-pdf" className="text-accent hover:underline">Merge PDF</Link>, <Link href="/tools/split-pdf" className="text-accent hover:underline">Split PDF</Link>
            </p>
          </div>
