...
const sections = [
  {
    ...
    description: "High-intent guides for healthcare, legal, compliance, and privacy-first PDF workflows.",
    articles: [
      {
        title: "Never Upload Medical Records",
        summary: "HIPAA, PHI, and why local processing should be the default for healthcare documents.",
      ...
      },
      {
        ...
        summary: "A practical workflow to prove whether a PDF tool sends document bytes to a server.",
      ...
      },
      {
        ...
        summary: "What XMP and Info Dictionary metadata can leak and how to remove hidden fields.",
      ...
      },
      {
        ...
        summary: "How to evaluate terms, data flow, and safer alternatives for sensitive PDF workflows.",
      ...
      },
      {
        ...
        summary: "Why black boxes fail and what irreversible redaction requires in real documents.",
      ...
      },
      {
        ...
        summary: "How to balance PDF size reduction against visual readability and print needs.",
      ...
      },
      {
        ...
        summary: "Visual vs cryptographic signatures and local signing workflows for private documents.",
      ...
      },
      {
        ...
        summary: "Controller/processor exposure and why client-side workflows reduce compliance burden.",
      ...
      },
      {
        ...
        summary: "A plain-language guide to WASM-powered local processing and offline capability.",
      ...
      },
      {
        ...
        summary: "How to generate searchable PDFs locally and avoid exposing sensitive scans.",
