        ...
        <article className="mx-auto max-w-3xl px-4 py-16 md:py-24">
          ...
          <section className="mt-12">
            ...
            <p className="mt-4 text-center text-[12px] text-muted-foreground/60">
              Also: <Link href="/tools/merge-pdf" className="text-accent/80 hover:text-accent hover:underline">Merge PDF</Link>, <Link href="/tools/split-pdf" className="text-accent/80 hover:text-accent hover:underline">Split PDF</Link>
            </p>
          </section>
