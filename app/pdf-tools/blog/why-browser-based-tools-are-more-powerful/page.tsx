  ...
  return (
    ...
    >
      ...
      <ArticleSection title="WebAssembly explained simply" id="webassembly-explained">
        ...
        <ArticleParagraph>
          For tools like{" "}
          <Link href="/pdf-tools/learn/how-plain-works" className="text-accent underline underline-offset-4 hover:text-accent/80 transition-colors">
            Plain
      ...
      <ArticleSection title="Limits of browser-based tools" id="limits">
        ...
        <ArticleParagraph>
          ...
          <Link href="/pdf-tools/learn/is-offline-pdf-processing-secure" className="text-accent underline underline-offset-4 hover:text-accent/80 transition-colors">
