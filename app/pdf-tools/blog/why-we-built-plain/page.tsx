  ...
  return (
    ...
    >
      ...
      <ArticleSection title="Why browser-based processing?">
        ...
        <ArticleNote>
          Plain uses{" "}
          <Link href="/pdf-tools/learn/how-plain-works" className="text-accent underline underline-offset-4 hover:text-accent/80">
            pdf-lib
          </Link>{" "}
      ...
      <ArticleSection title="Verifiable by design">
        ...
        <ArticleNote>
          ...
          <Link href="/pdf-tools/verify" className="text-accent underline underline-offset-4 hover:text-accent/80">
            How to Verify Plain
          </Link>.
        </ArticleNote>
      </ArticleSection>
