    ...
    >
      <ArticleSection title="PDF consistency: what you see is what everyone sees">
        ...
        <ArticleParagraph>
          ...
          <a href="/pdf-tools/learn/how-pdfs-work" className="text-accent underline underline-offset-4 hover:text-accent/80">
            how PDFs work
          </a>.
        </ArticleParagraph>
      </ArticleSection>
      ...
      <ArticleSection title="Why PDFs are trusted">
        ...
        <ArticleParagraph>
          ...
          <a href="/pdf-tools/learn/online-vs-offline-pdf-tools" className="text-accent underline underline-offset-4 hover:text-accent/80">
