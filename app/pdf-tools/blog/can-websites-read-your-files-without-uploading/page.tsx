      ...
      >
        ...
        <ArticleSection title="How to verify file behavior">
          ...
          <ArticleParagraph>
            ...
            <a href="/pdf-tools/verify" className="text-accent underline underline-offset-4 hover:text-accent/80">
              How to Verify Plain
            </a>.
          </ArticleParagraph>
        </ArticleSection>
        ...
        <ArticleSection title="Conclusion">
          ...
          <ArticleParagraph>
            ...
            <a href="/pdf-tools/learn/how-plain-works" className="text-accent underline underline-offset-4 hover:text-accent/80">
              How Plain Works
            </a>.
          </ArticleParagraph>
        </ArticleSection>
