        ...
        <article className="px-4 py-16 md:py-24">
          <div className="mx-auto max-w-2xl">
            ...
            <nav className="mb-8 flex items-center gap-2 text-[13px] text-muted-foreground/70">
              <Link href="/pdf-tools/" className="transition-colors hover:text-foreground">
                Home
              </Link>
              <span>/</span>
              <Link href="/pdf-tools/learn" className="transition-colors hover:text-foreground">
                Learn
              </Link>
              <span>/</span>
            ...
            <div className="prose-custom space-y-10">
              ...
              <section>
                ...
                <p className="mt-4 text-[15px] leading-relaxed text-muted-foreground">
                  ...
                  <Link href="/pdf-tools/learn/how-plain-works" className="text-accent underline underline-offset-4 transition-colors hover:text-accent/80">
                    How Plain Works
                  </Link>.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="mt-4 text-[15px] leading-relaxed text-muted-foreground">
                  ...
                  <Link href="/pdf-tools/privacy" className="text-accent underline underline-offset-4 transition-colors hover:text-accent/80">
                    Privacy by Design
                  </Link>.
                </p>
              </section>
