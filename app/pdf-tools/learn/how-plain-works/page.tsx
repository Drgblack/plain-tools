      ...
      <main className="flex-1 px-4 py-16 md:py-24">
        <article className="mx-auto max-w-2xl">
          ...
          <nav className="mb-8 flex items-center gap-2 text-sm text-muted-foreground">
            <Link href="/pdf-tools/learn" className="flex items-center gap-1 transition-colors hover:text-accent">
          ...
          <div className="mt-16 border-t border-accent/10 pt-10">
            ...
            <p className="mt-4 text-center text-[12px] text-muted-foreground/70">
              Also available: <Link href="/pdf-tools/tools/merge-pdf" className="text-accent hover:underline">Merge PDF</Link>, <Link href="/pdf-tools/tools/split-pdf" className="text-accent hover:underline">Split PDF</Link>, <Link href="/pdf-tools/tools/extract-pdf" className="text-accent hover:underline">Extract Pages</Link>
            </p>
          </div>
