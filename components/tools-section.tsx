...
const CATEGORY_CONFIG: CategoryConfig[] = [
  ...
  { id: "Edit", label: "Edit", hint: "Annotate and adjust", icon: PenTool },
  { id: "File Tools", label: "File tools", hint: "Encode and transform files", icon: FileCode },
  { id: "Network Tools", label: "Network", hint: "IP, DNS, status, and latency", icon: Globe },
  { id: "Utility", label: "Utility", hint: "General browser utilities", icon: QrCode },
